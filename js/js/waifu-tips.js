...
live2d_settings['waifuMinWidth']        = '0px';      // 面页小于 指定宽度 隐藏看板娘，例如 'disable'(禁用), '768px'
...
live2d_settings['homePageUrl']          = 'http://main.sakikency.top/index.html';       // 主页地址，可选 'auto'(自动), '{URL 网址}'
live2d_settings['aboutPageUrl']         = 'http://main.sakikency.top/index.html';   // 关于页地址, '{URL 网址}'
live2d_settings['screenshotCaptureName']= 'Mywaifu.png'; // 看板娘截图文件名，例如 'live2d.png'
...
function initModel(waifuPath, type) {
    ...
    $('.waifu-tool .fui-home').click(function (){   /*主页面设置*/
...
function loadTipsMessage(result) {
    ...
    function loadOtherModel() {
        ...
        $.ajax({
            cache: modelRandMode == 'rand' ? true : false,
